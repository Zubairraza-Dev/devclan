...
const InvolvementCard: React.FC<InvolvementCardProps> = ({ title, icon }) => {
  return (
    <div className="w-[48%] sm:w-[225px] h-[170px] sm:h-[230px] shadow-[0_2px_7px_rgba(0,0,0,0.1)] sm:shadow-[0_4px_15px_rgba(0,0,0,0.5)] flex flex-col items-center justify-center rounded-xl p-4">
